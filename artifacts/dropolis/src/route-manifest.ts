  ...
  },
  {
    ...
    jsonLd: {
      ...
      mainEntity: [
        ...
        { "@type": "Question", name: "Πώς μπορώ να υποβάλω νέο ή ανακοίνωση;", acceptedAnswer: { "@type": "Answer", text: "Επικοινωνήστε μαζί μας μέσω της σελίδας Επικοινωνία ή στο email dropolis9@gmail.com." } },
