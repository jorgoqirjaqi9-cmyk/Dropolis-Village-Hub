...
const STREAM_URL = "https://rdst.win:59450/stream";
const STATION_NAME = "Ράδιο Ήπειρος";
        ...
        <div className="fixed bottom-6 right-6 z-50 w-72 rounded-2xl shadow-2xl overflow-hidden border border-border/40 bg-card">
          ...
          <div className="bg-primary text-primary-foreground px-4 py-3 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="font-semibold text-sm leading-tight">{STATION_NAME}</p>
                <p className="text-[10px] text-primary-foreground/60">Live streaming</p>
              </div>
            </div>
            <button onClick={handleClose} className="text-primary-foreground/60 hover:text-primary-foreground transition-colors ml-2">
              <X className="w-4 h-4" />
            </button>
          </div>
