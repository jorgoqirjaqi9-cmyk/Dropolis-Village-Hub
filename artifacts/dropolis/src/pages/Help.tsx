...
const faqs: { q: string; a: string; category: string }[] = [
  {
    ...
    a: "Το Dropolis (Δρόπολη) είναι ένα ψηφιακό portal ειδήσεων, φωτογραφιών, βίντεο και κοινότητας για τα 42 χωριά του Δήμου Δρόπολης στη Βόρεια Ήπειρο (Αλβανία). Σκοπός του είναι να αποτελέσει τη ψηφιακή πλατεία της ελληνικής μειονότητας.",
  },
  {
    category: "Γενικά",
  ...
  },
  {
    ...
    a: "Επικοινωνήστε μαζί μας μέσω της σελίδας Επικοινωνία (/contact) ή στο email info@dropolis.gr. Η σύνταξη αξιολογεί κάθε υποβολή πριν τη δημοσίευση.",
  },
  {
    category: "Χωριά",
    q: "Πόσα χωριά καλύπτει το Dropolis;",
    a: "Το Dropolis καλύπτει και τα 42 χωριά του Δήμου Δρόπολης, κατανεμημένα σε τρεις Δημοτικές Ενότητες: Δρόπολης (16 χωριά), Άνω Δρόπολης (19 χωριά) και Πωγωνίου (7 χωριά).",
  },
  {
    category: "Φωτογραφίες",
    q: "Μπορώ να αναρτήσω δικές μου φωτογραφίες;",
    a: "Η δυνατότητα υποβολής φωτογραφιών από χρήστες βρίσκεται υπό ανάπτυξη. Προς το παρόν, μπορείτε να στείλετε φωτογραφίες στο info@dropolis.gr και η ομάδα θα τις αξιολογήσει για ανάρτηση.",
  },
  {
    category: "Κοινότητα",
  ...
  },
  {
    ...
    a: "Δοκιμάστε να ανανεώσετε τη σελίδα (Ctrl+Shift+R ή Command+Shift+R). Βεβαιωθείτε ότι χρησιμοποιείτε ενημερωμένο browser (Chrome, Firefox, Safari). Αν το πρόβλημα παραμένει, επικοινωνήστε μαζί μας στο support@dropolis.gr.",
  },
  {
    category: "Τεχνικά",
