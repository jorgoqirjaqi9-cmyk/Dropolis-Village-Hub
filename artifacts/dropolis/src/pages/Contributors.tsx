    ...
    <div className="container mx-auto px-4 py-10 max-w-3xl space-y-12">
      ...
      <motion.section initial="hidden" whileInView="show" viewport={{ once: true }} variants={fade} className="glass-card rounded-2xl p-6 border border-primary/15">
        ...
        <div className="flex flex-wrap gap-3">
          <a href="mailto:dropolis9@gmail.com?subject=Συνεισφορά" className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-5 py-2.5 rounded-full text-sm font-medium hover:bg-primary/90 transition-colors">
