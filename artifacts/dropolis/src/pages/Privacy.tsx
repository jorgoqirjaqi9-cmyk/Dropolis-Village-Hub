...
const sections = [
  {
    ...
    content: `Το Dropolis (dropolis.net) είναι ένα ψηφιακό portal ειδήσεων και κοινότητας αφιερωμένο στα χωριά της Δρόπολης (Βόρεια Ήπειρος, Αλβανία). Η παρούσα Πολιτική Απορρήτου περιγράφει τον τρόπο συλλογής, χρήσης και προστασίας των προσωπικών δεδομένων σας.`,
  },
  {
