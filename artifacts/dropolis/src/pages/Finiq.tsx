...
const MUNICIPAL_UNITS: { name: string; nameAl: string; villages: string[] }[] = [
  {
    name: "Φοινίκη",
    nameAl: "Finiq",
    villages: ["Φοινίκη (Finiqi)", "Βρίνα (Vrina)", "Μουρσιά (Mursia)", "Σκαλαριά (Skalara)"],
  },
  {
    name: "Δελβινάκι",
    nameAl: "Delvina",
    villages: ["Δελβινάκι (Delvina)", "Μεσόποταμος (Mesopotam)", "Σκραπάρι (Skrapari)", "Κόδερ (Kodër)"],
  },
  {
    name: "Αλυκό",
    nameAl: "Aliko",
    villages: ["Αλυκό (Aliko)", "Φτερρέ (Fterre)", "Νίβιτσα (Nivicë)", "Νινάτε (Ninatë)"],
  },
  {
    name: "Άγιος Βασίλειος",
    nameAl: "Shën Vasil",
    villages: ["Άγιος Βασίλειος (Shën Vasil)", "Λεκέλ (Lekël)", "Βρίον (Vrion)", "Στράτι (Strati)"],
  },
  {
    name: "Τσουκέ",
    nameAl: "Çukë",
    villages: ["Τσουκέ (Çukë)", "Βορς (Borsh)", "Λουκόβα (Lukovë)", "Πιέρσα (Piersë)"],
  },
  {
    name: "Γκρίκε",
    nameAl: "Grykë",
    villages: ["Γκρίκε (Grykë)", "Κάτω Γκρίκε", "Άνω Γκρίκε", "Κεπαρό (Keparë)"],
  },
  {
    name: "Κόδερ-Δελβινάκι",
    nameAl: "Kodër-Delvina",
    villages: ["Κόδερ (Kodër)", "Σαλαρί (Salari)", "Λιβινό (Livinë)"],
  },
  {
    name: "Σαλαρί",
    nameAl: "Salari",
    villages: ["Σαλαρί (Salari)", "Πάνω Σαλαρί", "Κάτω Σαλαρί"],
  },
];
