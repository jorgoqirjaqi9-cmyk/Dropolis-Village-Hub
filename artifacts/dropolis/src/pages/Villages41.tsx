...
const PAGE_TITLE = "Τα 41 Χωριά της Δρόπολης: Ιστορία, Πολιτισμός & Αξιοθέατα | Dropolis.net";
const PAGE_DESC  =
  "Πλήρης οδηγός για τα 41 χωριά της Δρόπολης στη Βόρεια Ήπειρο. Ιστορία, πολιτισμός, " +
  "αξιοθέατα, φωτογραφίες και νέα για κάθε χωριό της ελληνικής μειονότητας στο Αργυρόκαστρο.";
const PAGE_KW    =
    ...
    <>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-12 space-y-16">
        ...
        <H2Section id="ta-41-xoria" icon={MapPin} iconColor="bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400" title="Τα 41 χωριά της Δρόπολης">
          ...
          <H3>Χωριά της Κάτω Δρόπολης</H3>
          <Prose>
            <p>
              Η Κάτω Δρόπολη περιλαμβάνει τα χωριά της κοιλάδας και των πρόποδων, πολλά εκ των οποίων
              ...
              της Κάτω Δρόπολης με ισχυρή ελληνόφωνη παρουσία.
            </p>
          </Prose>

          <H3>Χωριά της Άνω Δρόπολης</H3>
          <Prose>
            <p>
              Τα χωριά της Άνω Δρόπολης βρίσκονται σε υψηλότερα υψόμετρα και διατηρούν συχνά αρχαιότερη
