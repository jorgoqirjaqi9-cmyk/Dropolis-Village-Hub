...
const faqs: { category: string; q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "Επικοινωνήστε μαζί μας μέσω της σελίδας Επικοινωνία (/contact) ή στο email info@dropolis.net. Η σύνταξη αξιολογεί κάθε υποβολή πριν τη δημοσίευση.",
  },
  {
    category: "Χωριά",
    q: "Πόσα χωριά καλύπτει το Dropolis;",
    a: "Το Dropolis καλύπτει και τα 41 χωριά του Δήμου Δρόπολης στη Βόρεια Ήπειρο (Αλβανία).",
  },
  {
    category: "Φωτογραφίες",
    q: "Μπορώ να αναρτήσω δικές μου φωτογραφίες;",
    a: "Η δυνατότητα υποβολής φωτογραφιών από χρήστες βρίσκεται υπό ανάπτυξη. Προς το παρόν, μπορείτε να στείλετε φωτογραφίες στο info@dropolis.net και η ομάδα θα τις αξιολογήσει για ανάρτηση.",
  },
  {
    category: "Κοινότητα",
  ...
  },
  {
    ...
    a: "Δοκιμάστε να ανανεώσετε τη σελίδα (Ctrl+Shift+R ή Command+Shift+R). Βεβαιωθείτε ότι χρησιμοποιείτε ενημερωμένο browser (Chrome, Firefox, Safari). Αν το πρόβλημα παραμένει, επικοινωνήστε μαζί μας στο info@dropolis.net.",
  },
  {
    category: "Τεχνικά",
