...
const faqItems = [
  { q: "Τι είναι η Δρόπολη;", a: "Η Δρόπολη (Dropull) είναι δήμος στον νομό Αργυροκάστρου της Αλβανίας. Αποτελεί ένα από τα σημαντικότερα κέντρα της ελληνικής μειονότητας στη Βόρεια Ήπειρο, με 41 χωριά κατανεμημένα σε τρεις δημοτικές ενότητες: Κάτω Δρόπολη, Άνω Δρόπολη και Πωγώνι." },
    ...
    <div className="container mx-auto px-4 py-8 space-y-16 max-w-4xl">
      ...
      <motion.section initial="hidden" whileInView="show" viewport={{ once: true }} variants={fade} className="space-y-6">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none text-foreground/80 leading-relaxed space-y-4">
          <p>
            Η Δρόπολη αποτελεί ένα από τα σημαντικότερα κέντρα της ελληνικής μειονότητας στη Βόρεια Ήπειρο. Τα 41 ιστορικά χωριά της — κατανεμημένα ανάμεσα στις δημοτικές ενότητες Κάτω Δρόπολης, Άνω Δρόπολης και Πωγωνίου — φέρουν μαζί τους αιώνες ελληνικής ιστορίας, γλώσσας και παράδοσης.
          </p>
          <p>
      ...
      <motion.section initial="hidden" whileInView="show" viewport={{ once: true }} variants={fade} className="space-y-6">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            { label: "Δημοτικές Ενότητες", value: "3", sub: "Κάτω Δρόπολης · Άνω Δρόπολης · Πωγωνίου" },
