...
const faqItems = [
  { q: "Τι είναι η Δρόπολη;", a: "Η Δρόπολη (Dropull) είναι δήμος στον νομό Αργυροκάστρου της Αλβανίας. Αποτελεί ένα από τα σημαντικότερα κέντρα της ελληνικής μειονότητας στη Βόρεια Ήπειρο, με 42 χωριά κατανεμημένα σε τρεις δημοτικές ενότητες: Δρόπολη, Άνω Δρόπολη και Πωγώνι." },
    ...
    <div className="container mx-auto px-4 py-8 space-y-16 max-w-4xl">
      ...
      <motion.section initial="hidden" whileInView="show" viewport={{ once: true }} variants={fade} className="space-y-6">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none text-foreground/80 leading-relaxed space-y-4">
          <p>
            Η Δρόπολη αποτελεί ένα από τα σημαντικότερα κέντρα της ελληνικής μειονότητας στη Βόρεια Ήπειρο. Τα 42 ιστορικά χωριά της — κατανεμημένα ανάμεσα στις δημοτικές ενότητες Δρόπολης, Άνω Δρόπολης και Πωγωνίου — φέρουν μαζί τους αιώνες ελληνικής ιστορίας, γλώσσας και παράδοσης.
          </p>
          <p>
            Το Dropolis δημιουργήθηκε με έναν ξεκάθαρο στόχο: να λειτουργεί ως η ψηφιακή πλατεία αυτής της κοινότητας. Ένα μέρος όπου οι ντόπιοι μπορούν να ενημερώνονται για τα τελευταία νέα, όπου η διασπορά διατηρεί τη σύνδεση με τη ρίζα της, και όπου επισκέπτες από όλο τον κόσμο μπορούν να ανακαλύψουν την ομορφιά και τον πλούτο αυτής της μοναδικής περιοχής.
          </p>
          <p>
      ...
      <motion.section initial="hidden" whileInView="show" viewport={{ once: true }} variants={fade} className="space-y-6">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            { label: "Δημοτικές Ενότητες", value: "3", sub: "Δρόπολης · Άνω Δρόπολης · Πωγωνίου" },
            { label: "Ιστορικά Χωριά", value: "42", sub: "Κάθε χωριό με μοναδική ταυτότητα" },
