...
const STATIC_META: Record<string, PageMeta> = {
  "/": {
    ...
    url: `${BASE_URL}/`,
    type: "website",
    bodyH1: "Dropolis - Τα Νέα της Δρόπολης",
    bodyP: "Τα τελευταία νέα για τη Δρόπολη (Dropolis) — ειδήσεις, φωτογραφίες, βίντεο και κοινότητα για τα 41 χωριά της Δρόπολης στη Βόρεια Ήπειρο, Αλβανία.",
    hreflang: [
    ...
    jsonLd: [
      ...
      },
      {
        ...
        keywords: "Δρόπολη, Dropolis, δρόπολη, δρόπολης, τα νέα της Δρόπολης, νέα Δρόπολη, dropolinews, dropoli news, Δρόπολη Αλβανία, Dropull, Βόρεια Ήπειρος, ελληνική μειονότητα, Αργυρόκαστρο, ειδήσεις",
      },
    ],
  },
  "/chat": {
  ...
  "/contact": {
    ...
    description: "Επικοινωνήστε με την ομάδα του Dropolis.net. Στείλτε μας τις δικές σας ειδήσεις, φωτογραφίες, προτάσεις ή ερωτήματα για τη Δρόπολη.",
  ...
  "/press": {
    ...
    description: "Γραφείο Τύπου του Dropolis.net. Διαβάστε δελτία τύπου, ανακοινώσεις, νέα της πλατφόρμας και πληροφορίες για τη συνεργασία με ΜΜΕ.",
    url: `${BASE_URL}/press/`,
  ...
  "/help": {
    ...
    description: "Κέντρο Βοήθειας του Dropolis.net. Βρείτε απαντήσεις σε συχνές ερωτήσεις, οδηγίες χρήσης της πλατφόρμας και τεχνική υποστήριξη.",
    url: `${BASE_URL}/help/`,
  ...
  "/privacy": {
    ...
    description: "Πολιτική Απορρήτου του Dropolis.net. Ενημερωθείτε για την ασφάλεια, την προστασία των προσωπικών δεδομένων και τα δικαιώματά σας.",
  ...
  "/terms": {
    ...
    description: "Όροι Χρήσης της ψηφιακής πλατφόρμας Dropolis.net. Διαβάστε αναλυτικά τους κανόνες λειτουργίας, τα δικαιώματα και τις υποχρεώσεις.",
    url: `${BASE_URL}/terms/`,
  ...
  "/cookie-policy": {
    ...
    description: "Πολιτική Cookies του Dropolis.net. Μάθετε πώς χρησιμοποιούμε τα cookies για τη βελτίωση της εμπειρίας πλοήγησης και της ταχύτητας.",
  ...
  "/disclaimer": {
    ...
    description: "Αποποίηση Ευθύνης για το Dropolis.net. Ενημερωθείτε για την εγκυρότητα του περιεχομένου, τις αναδημοσιεύσεις και την ευθύνη των ειδήσεων.",
  ...
  "/sitemap": {
    ...
    description: "Ολοκληρωμένος χάρτης ιστοτόπου (Sitemap) για το Dropolis.net. Πλοηγηθείτε εύκολα σε όλες τις σελίδες, τα χωριά και τις ειδήσεις μας.",
  ...
  "/finiq/villages": {
    ...
    bodyH1: "Χωριά και κοινότητες του Δήμου Φοινικαίων",
    bodyP: "Η ενότητα Φοινικαίων είναι ξεχωριστή από τα 41 χωριά της Δρόπολης και είναι αφιερωμένη στα χωριά και τις κοινότητες του Δήμου Φοινικαίων.",
  },
  "/finiq/photos": {
    ...
    bodyH1: "Φωτογραφικό αρχείο Φοινικαίων",
    bodyP: "Η ενότητα Φοινικαίων είναι ξεχωριστή από τα 41 χωριά της Δρόπολης και συγκεντρώνει φωτογραφίες από τα χωριά και τις κοινότητες του Δήμου Φοινικαίων.",
  },
  "/finiq/events": {
    ...
    bodyH1: "Εκδηλώσεις και πανηγύρια Φοινικαίων",
    bodyP: "Η ενότητα Φοινικαίων είναι ξεχωριστή από τα 41 χωριά της Δρόπολης και προβάλλει εκδηλώσεις, πανηγύρια και πολιτιστικές δράσεις του Δήμου Φοινικαίων.",
  },
  "/gastronomy": {
  ...
  "/dropoli-voreia-ipeiros": {
    title: "Δρόπολη & Βόρεια Ήπειρος: 41 Χωριά, Ιστορία και Πολιτισμός",
    titleFinal: "Δρόπολη & Βόρεια Ήπειρος: 41 Χωριά, Ιστορία και Πολιτισμός",
    ...
    bodyH1: "Δρόπολη & Βόρεια Ήπειρος: Τα 41 Χωριά, η Ιστορία και ο Πολιτισμός",
    bodyP: "Πλήρης οδηγός για τη Δρόπολη — τη γη των 41 ελληνικών χωριών, την κοιτίδα της ελληνικής μειονότητας στη Βόρεια Ήπειρο.",
  },
};
