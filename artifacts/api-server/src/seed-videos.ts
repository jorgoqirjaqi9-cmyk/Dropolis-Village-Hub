...
const VIDEOS: Array<{
  ...
  { youtubeId: "ElPerrSamw4", title: "Σελλειό Άνω Δρόπολης — Βορείου Ηπείρου", description: "Βίντεο από το Σελλειό της Άνω Δρόπολης.", villageId: 74, villageName: "Σελλιό" },
  ...
  { youtubeId: "vnnYicPWtvc", title: "Κοσσοβίτσα Άνω Δρόπολης 2017", description: "Βίντεο από την Κοσσοβίτσα της Άνω Δρόπολης, 2017.", villageId: 80, villageName: "Κοσσοβίτσα" },
